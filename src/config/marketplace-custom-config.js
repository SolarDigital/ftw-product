...
export const filters = [
  {
    ...
    config: {
      ...
      options: [
        { key: 'farm fresh produce', label: 'Farm Fresh Produce' },
        { key: 'vegan & plant based', label: 'Vegan & Plant Based' },
        { key: 'dairy, cheese, eggs', label: 'Dairy, Cheese, Eggs' },
        { key: 'organics', label: 'Organics'},
        { key: 'frozen fresh', label: 'Frozen Fresh'},
        { key: 'the pantry', label: 'The Pantry'},
        { key: 'spices & sauces', label: 'Spices & Sauces'},
